...
val armorData = [
	...
	RecipeData(81, 1, [<actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>], 50),  //soulbound
	RecipeData(88, 1, [<scalinghealth:heartcontainer>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>], 66),  //life-mending
	RecipeData(88, 2, [<scalinghealth:heartcontainer>, <scalinghealth:heartcontainer>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>], 100),  //life-mending
	RecipeData(88, 3, [<scalinghealth:heartcontainer>, <scalinghealth:heartcontainer>, <scalinghealth:heartcontainer>, <scalinghealth:heartcontainer>, <scalinghealth:heartcontainer>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>, <extrautils2:ingredients:10>], 160),  //life-mending
	...
	RecipeData(44, 1, [<minecraft:ender_pearl>, <minecraft:ender_pearl>, <minecraft:ender_pearl>, <minecraft:ender_pearl>], 50), //repellent
	RecipeData(44, 2, [<actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>], 75),  //repellent
	RecipeData(44, 3, [<minecraft:ender_eye>, <minecraft:ender_eye>, <actuallyadditions:block_misc:6>, <actuallyadditions:block_misc:6>], 111),  //repellent
	RecipeData(44, 4, [<minecraft:ender_eye>, <minecraft:ender_eye>, <minecraft:ender_eye>, <minecraft:ender_eye>], 160),  //repellent
	...
	RecipeData(97, 1, [<minecraft:piston>, <minecraft:piston>], 50), //rebounding
	RecipeData(97, 2, [<minecraft:piston>, <minecraft:piston>, <minecraft:piston>, <minecraft:piston>, <minecraft:piston>], 100), //rebounding
	RecipeData(97, 3, [<minecraft:piston>, <minecraft:piston>, <minecraft:piston>, <minecraft:piston>, <minecraft:piston>, <galacticraftcore:air_fan>, <galacticraftcore:air_fan>, <galacticraftcore:air_fan>, <galacticraftcore:air_fan>, <galacticraftcore:air_fan>], 160), //rebounding
	...
	RecipeData(89, 1, [<minecraft:packed_ice>, <minecraft:packed_ice>, <minecraft:packed_ice>, <minecraft:packed_ice>], 50), //icy thorns
	RecipeData(89, 2, [<cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>], 100), //icy thorns
	RecipeData(89, 3, [<cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <cavern:slippery_ice>, <botania:thornchakram>], 160), //icy thorns
	RecipeData(93, 1, [<minecraft:potion>.withTag({Potion: "minecraft:strength"}), <minecraft:potion>.withTag({Potion: "minecraft:strength"}), <minecraft:potion>.withTag({Potion: "minecraft:strength"})], 50),  //berserkers fury
	RecipeData(93, 2, [<minecraft:potion>.withTag({Potion: "minecraft:strong_strength"}), <minecraft:potion>.withTag({Potion: "minecraft:strong_strength"}), <minecraft:potion>.withTag({Potion: "minecraft:strong_strength"})], 75),  //berserkers fury
	RecipeData(93, 3, [<minecraft:potion>.withTag({Potion: "cofhcore:strength3"}), <minecraft:potion>.withTag({Potion: "cofhcore:strength3"}), <minecraft:potion>.withTag({Potion: "cofhcore:strength3"})], 111),  //berserkers fury
	RecipeData(93, 4, [<minecraft:potion>.withTag({Potion: "cofhcore:strength4"}), <minecraft:potion>.withTag({Potion: "cofhcore:strength4"}), <minecraft:potion>.withTag({Potion: "cofhcore:strength4"}), <minecraft:potion>.withTag({Potion: "cofhcore:strength4"})], 160),  //berserkers fury
	...
	RecipeData(25, 1, [<minecraft:gunpowder>, <minecraft:gunpowder>, <minecraft:gunpowder>, <minecraft:gunpowder>, <minecraft:tnt>, <minecraft:tnt>, <xreliquary:destruction_catalyst>], 75),  //unstable
	RecipeData(25, 2, [<aoa3:destruction_staff>, <minecraft:gunpowder>, <minecraft:gunpowder>, <minecraft:gunpowder>, <minecraft:tnt>, <minecraft:tnt>, <xreliquary:destruction_catalyst>], 160),  //unstable
	RecipeData(26, 1, [<actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <xreliquary:infernal_tear>, <minecraft:nether_star>], 100),  //last stand
	RecipeData(26, 1, [<actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <xreliquary:infernal_tear>, <extendedcrafting:storage:6>], 160),  //last stand
	RecipeData(96, 1, [<tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>], 50),  //occult aversion
	RecipeData(96, 2, [<tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte})], 75),  //occult aversion
	RecipeData(96, 3, [<tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:crafting_ingredient:3>, <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte}), <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte})], 111),  //occult aversion
	RecipeData(96, 4, [<tombstone:scroll_buff:3>.withTag({enchant: 1 as byte}), <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte}), <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte}), <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte}), <tombstone:scroll_buff:3>.withTag({enchant: 1 as byte})], 160)  //occult aversion
] as RecipeData[];
...
val bootData = [
	...
	RecipeData(30, 1, [<midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>], 25),  //shadow step
	RecipeData(30, 2, [<midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <minecraft:soul_sand>, <minecraft:soul_sand>], 50),  //shadow step
	RecipeData(30, 3, [<midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <minecraft:soul_sand>, <minecraft:soul_sand>, <enderio:item_material:74>], 75),  //shadow step
	RecipeData(30, 4, [<midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <minecraft:soul_sand>, <minecraft:soul_sand>, <enderio:item_material:74>, <extrabees:honey_comb:36>], 111),  //shadow step
	RecipeData(30, 5, [<midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <midnight:shadowroot_log>, <minecraft:soul_sand>, <minecraft:soul_sand>, <enderio:item_material:74>, <extrabees:honey_comb:36>, <aoa3:shadow_sapling>], 160)  //shadow step
] as RecipeData[];
...
val bowData = [
	...
	RecipeData(100, 1, [<minecraft:ender_eye>, <minecraft:ender_eye>, <minecraft:ender_eye>, <minecraft:ender_eye>, <minecraft:nether_star>], 100),  //endless quiver
	RecipeData(78, 1, [<botania:manaresource>, <botania:manaresource>, <psi:material:1>, <psi:material:1>, <extendedcrafting:material:8>], 50),  //multishot
	RecipeData(78, 2, [<botania:manaresource>, <botania:manaresource>, <psi:material:1>, <psi:material:1>, <extendedcrafting:material:9>], 75),  //multishot
	RecipeData(78, 3, [<botania:manaresource:7>, <botania:manaresource:7>, <psi:material:2>, <psi:material:2>, <extendedcrafting:material:10>], 111),  //multishot
	RecipeData(78, 4, [<botania:manaresource:4>, <botania:manaresource:14>, <psi:material:4>, <psi:material:3>, <extendedcrafting:material:11>], 160),  //multishot
] as RecipeData[];
...
val swordData = [
	...
	RecipeData(81, 1, [<minecraft:nether_brick>, <minecraft:nether_brick>, <minecraft:nether_brick>, <minecraft:blaze_powder>], 25),  //hell infusion
	RecipeData(81, 2, [<minecraft:nether_brick>, <minecraft:blaze_rod>, <minecraft:blaze_rod>, <minecraft:blaze_powder>], 50),  //hell infusion
	RecipeData(81, 3, [<minecraft:nether_brick>, <minecraft:blaze_rod>, <minecraft:blaze_rod>, <minecraft:blaze_powder>, <overloaded:compressed_netherrack:1>, <overloaded:compressed_netherrack:1>], 75),  //hell infusion
	RecipeData(40, 1, [<minecraft:skull:1>, <minecraft:skull:1>, <minecraft:skull:1>, <minecraft:skull:1>, <extrautils2:ingredients:10>], 75),  //decay
	...
	RecipeData(87, 1, [<minecraft:nether_star>, <minecraft:nether_star>, <minecraft:dragon_egg>], 85),  //scavenger
	RecipeData(77, 1, [<scalinghealth:crystalshard>, <scalinghealth:crystalshard>, <scalinghealth:crystalshard>, <scalinghealth:crystalshard>, <scalinghealth:crystalshard>], 50),  //leech
	RecipeData(77, 2, [<scalinghealth:crystalshard>, <scalinghealth:crystalshard>, <scalinghealth:crystalshard>, <scalinghealth:crystalshard>, <scalinghealth:heartcontainer>], 75),  //leech
	RecipeData(82, 1, [ <contenttweaker:crazy_creeper_essence>], 50),  //vorpal
	RecipeData(84, 1, [<minecraft:saddle>], 25),  //mounted strike
	RecipeData(84, 2, [<minecraft:saddle>, <minecraft:saddle>], 50),  //mounted strike
	RecipeData(84, 3, [<minecraft:saddle>, <minecraft:saddle>, <minecraft:saddle>, <minecraft:saddle>], 75),  //mounted strike
	RecipeData(36, 1, [<minecraft:potion>.withTag({Potion: "cofhcore:healing4"}),<minecraft:potion>.withTag({Potion: "cofhcore:healing4"}),<minecraft:potion>.withTag({Potion: "cofhcore:healing4"})], 75),  //magic siphon
	RecipeData(99, 1, [<minecraft:diamond_block>, <minecraft:diamond_block>, <minecraft:diamond_block>, <minecraft:emerald_block>, <minecraft:emerald_block>, <minecraft:emerald_block>, <overloaded:nether_star_block>], 100),  //capturing
	RecipeData(94, 1, [<actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <enderio:item_xp_transfer>], 50),  //knowledge of the ages
	RecipeData(94, 2, [<actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <actuallyadditions:item_solidified_experience>, <enderio:item_xp_transfer>, <enderio:item_xp_transfer>], 75),  //knowledge of the ages
	RecipeData(64, 1, [<enderio:block_enderman_skull>], 25),  //uncivilized
	RecipeData(64, 2, [<enderio:block_enderman_skull>, <enderio:block_enderman_skull>], 50),  //uncivilized
	RecipeData(64, 3, [<enderio:block_enderman_skull>, <enderio:block_enderman_skull>, <enderio:block_enderman_skull>], 75),  //uncivilized
	RecipeData(37, 1, [<minecraft:rotten_flesh>, <biomesoplenty:fleshchunk>, <minecraft:poisonous_potato>], 50),  //plague bringer
	RecipeData(37, 2, [<minecraft:rotten_flesh>, <minecraft:rotten_flesh>, <biomesoplenty:fleshchunk>, <biomesoplenty:fleshchunk>, <minecraft:poisonous_potato>, <minecraft:poisonous_potato>], 75),  //plague bringer
] as RecipeData[];
...
val toolData = [
	...
	RecipeData(85, 1, [<overloaded:compressed_stone>, <overloaded:compressed_stone>, <overloaded:compressed_stone>, <minecraft:obsidian>], 25),  //miners ferver
	RecipeData(85, 2, [<minecraft:obsidian>, <minecraft:obsidian>, <minecraft:obsidian>, <overloaded:compressed_obsidian>], 50),  //miners ferver
	RecipeData(85, 3, [<overloaded:compressed_obsidian>, <overloaded:compressed_obsidian>, <overloaded:compressed_obsidian>, <overloaded:compressed_obsidian:1>], 75),  //miners ferver
	RecipeData(85, 4, [<overloaded:compressed_obsidian:1>, <overloaded:compressed_obsidian:1>, <overloaded:compressed_obsidian:1>, <overloaded:compressed_obsidian:2>], 111),  //miners ferver
	RecipeData(85, 5, [<overloaded:compressed_obsidian:2>, <overloaded:compressed_obsidian:2>, <overloaded:compressed_obsidian:2>, <overloaded:compressed_obsidian:3>], 160),  //miners ferver
...
val hoeData = [
    RecipeData(88, 1, [<minecraft:wheat>, <minecraft:wheat>, <minecraft:golden_apple>, <minecraft:golden_apple>, <minecraft:fish>, <minecraft:fish>, <minecraft:golden_carrot>, <minecraft:golden_carrot>], 75),  //temptation
    RecipeData(94, 1, [<minecraft:dye:15>, <minecraft:dye:15>, <minecraft:dye:15>, <minecraft:dye:15>, <minecraft:dye:15>, <silentgems:glowrosefertilizer>, <silentgems:glowrosefertilizer>, <silentgems:glowrosefertilizer>, <botania:fertilizer>, <botania:fertilizer>], 75)  //natures blessing
] as RecipeData[];

val fishingData = [
    RecipeData(105, 1, [<minecraft:fish>, <minecraft:fish>, <minecraft:fish>], 25),  //appealing
    RecipeData(105, 2, [<minecraft:fish>, <minecraft:fish>, <minecraft:fish>, <minecraft:fish:2>, <minecraft:fish:2>, <minecraft:fish:2>], 50),  //appealing
    RecipeData(105, 3, [<minecraft:fish>, <minecraft:fish>, <minecraft:fish>, <minecraft:fish:2>, <minecraft:fish:2>, <minecraft:fish:2>, <minecraft:fish:3>, <minecraft:fish:3>, <minecraft:fish:3>], 75),  //appealing
	RecipeData(105, 4, [<minecraft:fish>, <minecraft:fish>, <aquaculture:fish:16>, <minecraft:fish:2>, <minecraft:fish:2>, <aquaculture:fish:16>, <minecraft:fish:3>, <minecraft:fish:3>, <aquaculture:fish:16>], 111),  //appealing
	RecipeData(105, 5, [<minecraft:fish>, <aquaculture:fish:16>, <aquaculture:fish:16>, <minecraft:fish:2>, <aquaculture:fish:16>, <aquaculture:fish:16>, <minecraft:fish:3>, <aquaculture:fish:16>, <aquaculture:fish:16>], 160),  //appealing
	RecipeData(111, 1, [<minecraft:iron_block>], 25),
    RecipeData(111, 2, [<minecraft:iron_block>, <minecraft:iron_block>], 50),
    RecipeData(111, 3, [<minecraft:iron_block>, <minecraft:iron_block>, <minecraft:iron_block>], 75),
	RecipeData(106, 1, [<aquaculture:loot:1>], 25),  //magnetic
    RecipeData(106, 2, [<aquaculture:loot:1>, <aquaculture:loot:1>], 50),  //magnetic
    RecipeData(106, 3, [<aquaculture:loot:1>, <aquaculture:loot:1>, <aquaculture:loot:1>], 75),  //magnetic
	RecipeData(110, 1, [<extrautils2:spike_iron>], 25),  //barbed hook
    RecipeData(110, 2, [<extrautils2:spike_iron>, <extrautils2:spike_iron>], 50),  //barbed hook
    RecipeData(110, 3, [<extrautils2:spike_iron>, <extrautils2:spike_iron>, <extrautils2:spike_iron>], 75),  //barbed hook
	RecipeData(109, 1, [<aquaculture:iron_fishing_rod>], 25),  //double hook
    RecipeData(109, 2, [<aquaculture:iron_fishing_rod>, <aquaculture:iron_fishing_rod>], 50),  //double hook
    RecipeData(109, 3, [<aquaculture:iron_fishing_rod>, <aquaculture:iron_fishing_rod>, <aquaculture:iron_fishing_rod>], 75),  //double hook
	RecipeData(107, 1, [<minecraft:string>, <minecraft:string>], 25),  //long cast
    RecipeData(107, 2, [<minecraft:string>, <minecraft:string>, <minecraft:string>, <minecraft:string>], 50),  //long cast
    RecipeData(107, 3, [<minecraft:string>, <minecraft:string>, <minecraft:string>, <minecraft:string>, <minecraft:string>, <minecraft:string>, <minecraft:string>, <minecraft:string>], 75),  //long cast
	RecipeData(108, 1, [<biomesoplenty:plant_0>, <biomesoplenty:plant_0>], 25),  //short cast
    RecipeData(108, 2, [<biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>], 50),  //short cast
    RecipeData(108, 3, [<biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>, <biomesoplenty:plant_0>], 75),  //short cast
